# Impeccable Page Runbook — ✅ Sweep complete (35 / 35)
...
>
> **Status (2026-05-13):** all 35 rows across 9 waves have a published findings log with Phase 3 applied. Wave 9 (HAWKS) closed same-day as it opened — 4 logs, 5 P0s resolved (1 Earned-Bronze fix on the trade-form, 1 Pattern-B verdict-as-P&L fix on settings, 2 a11y reference fixes) plus 2 new UI primitives (`FeatureStamp`, `HelpText`). Outstanding cross-page work lives in [`docs/backlog.md`](backlog.md).
...
Pages are grouped into nine waves. Run waves sequentially; within a wave, run pages in the listed order. Each wave establishes patterns that the next wave inherits — skipping ahead means re-doing extraction work later.

**Rationale (read once, then trust the order):** Wave 1 is the trader's daily cockpit and where the most reusable patterns live. Waves 2–4 are heavy data and modeling surfaces that share grammar with the cockpit. Wave 5 covers form editors, which inherit from Wave 1 detail views. Waves 6–8 are self-contained leaves (settings, auth, public). Wave 9 (HAWKS) is a feature-cross-cut: the same HAWKS feature grafted bands onto four already-swept pages, so the wave runs the runbook scoped to the new bands only — the pages themselves keep their 2026-05-12 sign-offs.
...
| 10  | 2 — Heavy data    | monthly review       | `monthly`              | `/monthly`                          | [scans/2026-05-12-impeccable-monthly.md](scans/2026-05-12-impeccable-monthly.md) — Phase 3 done                       |
| 11  | 3 — Modeling      | backtest             | `backtest`             | `/backtest`                         | [scans/2026-05-12-impeccable-backtest.md](scans/2026-05-12-impeccable-backtest.md) — Phase 3 done                     |
| 12  | 3 — Modeling      | backtest optimize    | `backtest-optimize`    | `/backtest/optimize`                | [scans/2026-05-12-impeccable-backtest-optimize.md](scans/2026-05-12-impeccable-backtest-optimize.md) — Phase 3 done   |
| 13  | 3 — Modeling      | monte carlo          | `monte-carlo`          | `/monte-carlo`                      | [scans/2026-05-12-impeccable-monte-carlo.md](scans/2026-05-12-impeccable-monte-carlo.md) — Phase 3 done               |
| 14  | 3 — Modeling      | risk simulation      | `risk-simulation`      | `/risk-simulation`                  | [scans/2026-05-12-impeccable-risk-simulation.md](scans/2026-05-12-impeccable-risk-simulation.md) — Phase 3 done       |
| 15  | 3 — Modeling      | equity shield        | `equity-shield`        | `/equity-shield`                    | [scans/2026-05-12-impeccable-equity-shield.md](scans/2026-05-12-impeccable-equity-shield.md) — Phase 3 done           |
| 16  | 4 — Planning      | plan year            | `plan-year`            | `/plan/[year]`                      | [scans/2026-05-12-impeccable-plan-wave4.md](scans/2026-05-12-impeccable-plan-wave4.md) — Phase 3 done                 |
| 17  | 4 — Planning      | plan quarter         | `plan-quarter`         | `/plan/[year]/[quarter]`            | [scans/2026-05-12-impeccable-plan-wave4.md](scans/2026-05-12-impeccable-plan-wave4.md) — Phase 3 done                 |
| 18  | 4 — Planning      | plan month           | `plan-month`           | `/plan/[year]/[quarter]/[month]`    | [scans/2026-05-12-impeccable-plan-wave4.md](scans/2026-05-12-impeccable-plan-wave4.md) — Phase 3 done                 |
| 19  | 5 — Form editors  | journal new          | `journal-new`          | `/journal/new`                      | [scans/2026-05-12-impeccable-form-editors-wave5.md](scans/2026-05-12-impeccable-form-editors-wave5.md) — Phase 3 done |
| 20  | 5 — Form editors  | journal edit         | `journal-edit`         | `/journal/[id]/edit`                | [scans/2026-05-12-impeccable-form-editors-wave5.md](scans/2026-05-12-impeccable-form-editors-wave5.md) — Phase 3 done |
| 21  | 5 — Form editors  | playbook new         | `playbook-new`         | `/playbook/new`                     | [scans/2026-05-12-impeccable-form-editors-wave5.md](scans/2026-05-12-impeccable-form-editors-wave5.md) — Phase 3 done |
| 22  | 5 — Form editors  | playbook edit        | `playbook-edit`        | `/playbook/[id]/edit`               | [scans/2026-05-12-impeccable-form-editors-wave5.md](scans/2026-05-12-impeccable-form-editors-wave5.md) — Phase 3 done |
| 23  | 6 — Settings      | settings             | `settings`             | `/settings`                         | [scans/2026-05-12-impeccable-settings-wave6.md](scans/2026-05-12-impeccable-settings-wave6.md) — Phase 3 done         |
| 24  | 7 — Auth          | login                | `login`                | `/login`                            | [scans/2026-05-12-impeccable-auth-wave7.md](scans/2026-05-12-impeccable-auth-wave7.md) — Phase 3 done                 |
| 25  | 7 — Auth          | register             | `register`             | `/register`                         | [scans/2026-05-12-impeccable-auth-wave7.md](scans/2026-05-12-impeccable-auth-wave7.md) — Phase 3 done                 |
...
| 31  | 9 — HAWKS         | dashboard (HAWKS)    | `dashboard-hawks`      | `/` (Coaching Insights card)        | [scans/2026-05-13-impeccable-dashboard-hawks.md](scans/2026-05-13-impeccable-dashboard-hawks.md) — Phase 3 done       |
| 32  | 9 — HAWKS         | journal list (HAWKS) | `journal-list-hawks`   | `/journal` (Daily Bias panel)       | [scans/2026-05-13-impeccable-journal-list-hawks.md](scans/2026-05-13-impeccable-journal-list-hawks.md) — Phase 3 done |
| 33  | 9 — HAWKS         | journal new (HAWKS)  | `journal-new-hawks`    | `/journal/new` (HAWKS fields)       | [scans/2026-05-13-impeccable-trade-form-hawks.md](scans/2026-05-13-impeccable-trade-form-hawks.md) — Phase 3 done     |
| 34  | 9 — HAWKS         | journal edit (HAWKS) | `journal-edit-hawks`   | `/journal/[id]/edit` (HAWKS fields) | [scans/2026-05-13-impeccable-trade-form-hawks.md](scans/2026-05-13-impeccable-trade-form-hawks.md) — Phase 3 done     |
| 35  | 9 — HAWKS         | settings (HAWKS)     | `settings-hawks`       | `/settings` (HAWKS tab)             | [scans/2026-05-13-impeccable-settings-hawks.md](scans/2026-05-13-impeccable-settings-hawks.md) — Phase 3 done         |
...
**Wave 9 scope note:** rows 31–35 cover **only the HAWKS bands** grafted onto already-swept pages — not the host pages themselves. Each log starts with the host page's 2026-05-12 sign-off as inherited baseline and reviews the HAWKS-added DOM only. Rows 33 + 34 share one log because both mount the same `<HawksTradeFields>` block via `trade-form.tsx` (mirroring Wave 5's combined form-editors log).
