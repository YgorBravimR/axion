...
const Loading = () => {
	return (
		<div className="min-h-dvh bg-bg-100 p-m-400 sm:p-m-500 lg:p-m-600" role="status" aria-live="polite">
			<span className="sr-only">Loading...</span>
			{/* Header skeleton */}
			<header className="mb-m-500 flex w-full items-center justify-between sm:mb-l-700">
				<div>
					<div className="h-10 w-48 animate-pulse motion-reduce:animate-none rounded-lg bg-bg-200 sm:h-12 sm:w-64" />
					<div className="mt-s-200 h-5 w-56 animate-pulse motion-reduce:animate-none rounded-lg bg-bg-200 sm:h-6 sm:w-96" />
				</div>
				<div className="h-10 w-10 animate-pulse motion-reduce:animate-none rounded-lg bg-bg-200" />
			</header>
