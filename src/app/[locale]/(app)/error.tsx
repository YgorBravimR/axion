 ...
 * Catches errors from pages like command-center, journal, etc.
 * Shows a generic error message to prevent leaking internal error details.
 *
...
const AppError = (props: {
	...
	return (
		<div className="bg-bg-100 p-m-400 sm:p-m-600 flex min-h-dvh items-center justify-center">
			<Card
				id="error-boundary-card"
				className="bg-bg-200 p-m-500 sm:p-l-700 max-w-lg shadow-xl"
			>
				<div className="flex flex-col items-center text-center">
					...
					<p className="mt-m-400 text-body text-txt-200">{t("description")}</p>
