...
import { HawksAnalyticsDashboard } from "@/components/hawks"

const HawksAnalyticsPage = async () => {
	...
	const t = await getTranslations("hawksAnalytics.page")

	return (
		<div className="mx-auto max-w-6xl space-y-m-500 px-m-600 py-l-700">
			...
			<HawksAnalyticsDashboard />
		</div>
	)
}

export default HawksAnalyticsPage
