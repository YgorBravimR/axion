...
import { HawksCalendar } from "@/components/hawks"

const HawksCalendarPage = async () => {
	...
	const t = await getTranslations("hawksCalendar.page")
...
export default HawksCalendarPage
