...
import { HawksCalibrationCard } from "@/components/hawks"

const HawksCalibrationPage = async () => {
	...
	const t = await getTranslations("hawksCalibration.page")
	...
	return (
		<div className="mx-auto max-w-3xl space-y-m-500 px-m-600 py-l-700">
			...
			<HawksCalibrationCard />
		</div>
	)
}

export default HawksCalibrationPage
