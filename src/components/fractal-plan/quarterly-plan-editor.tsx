...
const QuarterlyPlanEditor = ({ quarterlyPlanId, existing }: QuarterlyPlanEditorProps) => {
	...
	return (
		...
		>
			<div>
				<Label htmlFor="quarter-goal">Quarter goal (BRL)</Label>
				<Input
					id="quarter-goal"
					type="number"
					step="0.01"
			...
			<div>
				<Label htmlFor="quarter-intent">Reflection / intent</Label>
				<Textarea
					id="quarter-intent"
					rows={3}
			...
			<div>
				<Label htmlFor="quarter-postmortem">Post-mortem</Label>
				<Textarea
