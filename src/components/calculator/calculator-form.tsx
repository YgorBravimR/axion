...
const PrefilledBadge = memo(({ label }: { label: string }) => (
	<span className="ml-s-200 gap-s-100 bg-acc-100/15 px-s-200 text-micro text-acc-100 inline-flex items-center rounded-sm py-px">
				...
				<div>
					...
					<div className="gap-s-200 grid grid-cols-2">
						<button
							...
							className={cn(
								"gap-s-200 px-m-400 py-s-300 text-small flex items-center justify-center rounded-md border font-medium transition-colors",
								direction === "long"
