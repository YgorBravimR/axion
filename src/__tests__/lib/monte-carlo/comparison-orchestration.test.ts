...
const createMockComparisonResult = (
	...
	result: {
		statistics: {
			...
			meanMaxRDrawdown: -5.5,
			worstMaxRDrawdown: -12,
			profitablePct: 72.5,
			sharpeRatio: 1.8,
			sortinoRatio: 2.1,
			expectedRPerTrade: 0.25,
			expectedMaxWinStreak: 8,
		...
		distributionBuckets: [
			...
			{ rangeStart: 10, rangeEnd: 25, count: 400, percentage: 40 },
			{ rangeStart: 25, rangeEnd: 50, count: 350, percentage: 35 },
			{ rangeStart: 50, rangeEnd: 100, count: 150, percentage: 15 },
		],
		sampleRun: {
			runId: 1,
			trades: [
